...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            String jsonResponse = "";
            // check if the url is null and avoid connection attempt if so
            if (url == null) {
                return jsonResponse;
            }
            ...
            try {
                ...
                // check the response code and parse only if it is OK
                ...
                Log.e(LOG_TAG, "Server response code was not 200 but: " + urlConnection.getResponseCode(), e);
            } finally {
